#import dependencies
from Churn_Rate import ML_model, calculate, change_to_YN, origin_prob, compare_scenario
...
def samples(customerID):
    ...
    # Filter the data based on the customerID number and only keep rows with values above 1
